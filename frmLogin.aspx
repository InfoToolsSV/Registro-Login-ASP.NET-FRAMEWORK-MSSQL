<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="frmLogin.aspx.cs" Inherits="InfoToolsSV.frmLogin" %>
        ...
        <div class="formcontent">
            <form id="formulario_login" runat="server">
                <div class="form-control">
                    ...
                    <br />
                    <div class="row">
                        <asp:Button runat="server" ID="BtnRegistro" CssClass="btn btn-primary btn-info" Text="Registrarse" OnClick="BtnRegistro_Click"/>
                    </div>
                </div>
            </form>
        </div>
